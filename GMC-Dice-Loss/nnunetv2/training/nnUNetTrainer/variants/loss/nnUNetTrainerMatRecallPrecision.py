...
from nnunetv2.training.loss.compound_losses import DC_SkelREC_and_CE_loss, DC_MatREC_and_CE_loss,DC_MatRECPrecision_and_CE_loss
...
class nnUNetTrainerMatRecallPrecision(nnUNetTrainer):
    ...
    def _build_loss(self):
        ...
        loss = DC_MatRECPrecision_and_CE_loss(soft_dice_kwargs={'batch_dice': self.configuration_manager.batch_dice, 
