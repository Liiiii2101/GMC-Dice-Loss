...
from nnunetv2.training.loss.compound_losses import DC_SkelREC_and_CE_loss, DC_MatREC_and_CE_loss,DC_MatRECPrecision_and_CE_loss,DC_MatRECPrecisionDSC_and_CE_loss,DC_MatRECSkelitePrecisionDSC_and_CE_loss
...
class nnUNetTrainerMatRecallPrecisionSkeliteDSC1(nnUNetTrainer):
    ...
    def _build_loss(self):
        ...
        loss = DC_MatRECSkelitePrecisionDSC_and_CE_loss(self.skel_model, soft_dice_kwargs={'batch_dice': self.configuration_manager.batch_dice, 
