...
class nnUNetTrainerSwinUNETR_CE_DC_Skelite(nnUNetTrainerSwinUNETR):
    ...
    def _build_loss(self):
        ...
        loss = DC_and_CE_and_Skelite_loss({'batch_dice': self.configuration_manager.batch_dice, 'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, {},
