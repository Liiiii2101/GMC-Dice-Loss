...
from nnunetv2.nets.nnFormer_tumor import nnFormer
from typing import Tuple, Union, List
from torch.cuda.amp import GradScaler
class nnUNetTrainernnFormer(nnUNetTrainer):#(nnUNetTrainer):#(nnUNetTrainerNoDeepSupervision):
    """
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        model = nnFormer(crop_size=[96,160,160],
                embedding_dim=96,
                input_channels=1, 
                num_classes=2, 
                conv_op=nn.Conv3d, 
