...
from nnunetv2.training.loss.cldice_loss_topology import SoftclDiceLoss
from nnunetv2.utilities.helpers import softmax_helper_dim1
from torch import nn

class DC_and_CE_and_CLDC_loss_topology(nn.Module):
    def __init__(self, soft_dice_kwargs, ce_kwargs, cldc_kwargs, weight_ce=1, weight_dice=1, weight_cldice=1, ignore_label=None,
        ...
        :param weight_ti:
        """
        super(DC_and_CE_and_CLDC_loss_topology, self).__init__()
